        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    ...
                    @if ($ad && $ad->home_middle_ad_status == 1)
                                        ...
                                        <div class="article__entry">
                                            <div class="article__image">
                                                <a href="{{ route('news-details', $mostViewPosts->slug) }}">
                                                    <img src="{{ asset($mostViewPosts->image) }}" alt=""
                                                        class="img-fluid">
                                                </a>
                                            </div>
                                            <div class="article__content">
                                                <div class="article__category">
                                                    {{ $mostViewPosts->category->name }}
                                                </div>
                                                <ul class="list-inline">
                                                    <li class="list-inline-item">
                                                        <span class="text-primary">
                                                            {{ __('frontend.by') }} {{ $mostViewPosts->author->name }}
                                                        </span>
                                                    </li>
                                                    <li class="list-inline-item">
                                                        <span class="text-dark text-capitalize">
                                                            {{ date('M d, Y', strtotime($mostViewPosts->created_at)) }}
                                                        </span>
                                                    </li>
                                                ...
                                                <h5>
                                                    <a href="{{ route('news-details', $mostViewPosts->slug) }}">
                                                        {!! truncate($mostViewPosts->title) !!}
                                                    </a>
                                                </h5>
                                                <p>
                                                    {!! truncate($mostViewPosts->content) !!}
                                                </p>
                                                <a href="{{ route('news-details', $mostViewPosts->slug) }}"
                                    ...
                                    @if ($loop->index > 0)
                                        <div class="mb-3">
                                            ...
                                            <div class="card__post card__post-list">
                                                <div class="image-sm">
                                                    <a href="{{ route('news-details', $mostViewPosts->slug) }}">
                                                        <img src="{{ asset($mostViewPosts->image) }}"
                                                            class="img-fluid" alt="">
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card__post__body ">
                                                    <div class="card__post__content">
                                                        ...
                                                        <div class="card__post__title">
                                                            <h6>
                                                                <a
                                                                    href="{{ route('news-details', $mostViewPosts->slug) }}">
                                                                    {!! truncate($mostViewPosts->title) !!}
                                                                </a>
                                                            </h6>
                                                        </div>
